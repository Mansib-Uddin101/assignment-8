        ...
        <div className="card-body">
          ...
          <form onSubmit={handleSignIn}>
            ...
            <div className="form-control w-full mt-4">
              <label className="label p-0"><span className="label-text font-semibold text-gray-700">Password</span></label>
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Link href="/auth/signup" className="font-semibold text-[#00d1b2] hover:underline">Sign up for free</Link>
          </div>
        </div>
      </div>
    </div>
